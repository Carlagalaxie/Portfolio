...
# ------------------------------
# Animation 3D (GIF pour le web)
# ------------------------------
fig = plt.figure(figsize=(8,6), dpi=120)  # taille et résolution pour le web
...
step = 20       # saute 20 pas de temps par frame
interval_ms = 10  # rafraîchissement toutes les 10 ms
...
# Sauvegarde GIF
# ------------------------------
ani.save("diffusion_chaleur.gif", writer="pillow", fps=30, dpi=120)
plt.show()
