...
plt.loglog(NX_tab, Err_tab1, 'o-', label="Erreur à t=0.5")
plt.loglog(NX_tab, Err_tab2, 's-', label="Erreur à t=1.0")
plt.xlabel("Nombre de points (NX)")
plt.ylabel("Erreur L2")
plt.title("Convergence de l'erreur pour différents maillages")
plt.legend()
